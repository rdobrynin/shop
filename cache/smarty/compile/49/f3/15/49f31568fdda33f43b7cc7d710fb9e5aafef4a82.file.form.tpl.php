<?php /* Smarty version Smarty-3.1.19, created on 2015-01-28 15:22:20
         compiled from "/Applications/MAMP/htdocs/shop/admin123/themes/default/template/controllers/tags/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:124937733754c8e28cd8b077-73883558%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '49f31568fdda33f43b7cc7d710fb9e5aafef4a82' => 
    array (
      0 => '/Applications/MAMP/htdocs/shop/admin123/themes/default/template/controllers/tags/helpers/form/form.tpl',
      1 => 1420617954,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '124937733754c8e28cd8b077-73883558',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54c8e28ef412e0_17031136',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8e28ef412e0_17031136')) {function content_54c8e28ef412e0_17031136($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/shop/tools/smarty/plugins/function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '124937733754c8e28cd8b077-73883558');
content_54c8e28e72d3d3_98566275($_smarty_tpl);
...
<div class="row">
	<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Products:'),$_smarty_tpl);?>
</label>
 ...
 $_from = $_smarty_tpl->tpl_vars['field']->value['products_unselected']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 ...
 <i class="icon-arrow-right"></i>
			...
			<div class="col-lg-6">
				<select multiple id="select_right" name="products[]">
					<?php  $_smarty_tpl->tpl_vars['product'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['product']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['field']->value['products']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['product']->key => $_smarty_tpl->tpl_vars['product']->value) {
$_smarty_tpl->tpl_vars['product']->_loop = true;
?>
...
"><?php echo $_smarty_tpl->tpl_vars['product']->value['name'];?>
				...
				<a href="#" id="move_to_left" class="btn btn-default btn-block multiple_select_remove">
					<i class="icon-arrow-left"></i> <?php echo smartyTranslate(array('s'=>'Remove'),$_smarty_tpl);?>
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2015-01-28 15:22:22
         compiled from "/Applications/MAMP/htdocs/shop/admin123/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_54c8e28e72d3d3_98566275')) {function content_54c8e28e72d3d3_98566275($_smarty_tpl) {?>
