<?php /* Smarty version Smarty-3.1.19, created on 2015-01-28 15:46:47
         compiled from "/Applications/MAMP/htdocs/shop/modules/blocklayered/views/templates/hook/feature_form_1.6.tpl" */ ?>
<?php /*%%SmartyHeaderCode:154674035054c8e8470eff65-29502366%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3e24429e3c179fd4c465b3d07b3652302e0cf9bf' => 
    array (
      0 => '/Applications/MAMP/htdocs/shop/modules/blocklayered/views/templates/hook/feature_form_1.6.tpl',
      1 => 1422448710,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '154674035054c8e8470eff65-29502366',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54c8e8472285d0_89212273',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c8e8472285d0_89212273')) {function content_54c8e8472285d0_89212273($_smarty_tpl) {?>
...
?>
			...
			<?php } ?>
			<div class="col-lg-9">
				<p class="help-block"><?php echo smartyTranslate(array('s'=>'When the Layered Navigation Block module is enabled, you can get more detailed URLs by choosing the word that best represent this feature. By default, PrestaShop uses the feature\'s name, but you can change that setting using this field.','mod'=>'blocklayered'),$_smarty_tpl);?>
</p>
			</div>
		</div>
	</div>
...
?>
			...
			<?php } ?>
			<div class="col-lg-9">
				<p class="help-block"><?php echo smartyTranslate(array('s'=>'When the Layered Navigation Block module is enabled, you can get more detailed page titles by choosing the word that best represent this feature. By default, PrestaShop uses the feature\'s name, but you can change that setting using this field.','mod'=>'blocklayered'),$_smarty_tpl);?>
</p>
			</div>
		</div>
	</div>
